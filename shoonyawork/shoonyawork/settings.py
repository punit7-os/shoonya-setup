"""
Django settings for shoonyawork project.
...
SECRET_KEY = 'django-insecure-&bh3qnz_8i17yam^#=iv4*t=$v9c)d2p@q-$r+o$@m7#9lkm%z'
...
TEMPLATES = [
    {
        ...
        'DIRS': [ 'shoonyawork/templates',
        'tentothree/templates/tentothree',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
